        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="p-8 bg-white border border-gray-200 rounded-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">AI Engineer — Agentic Systems</h3>
              ...
              <div className="mb-4">
                <h4 className="font-semibold text-gray-900 mb-2">You will:</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 mb-2">We&rsquo;re looking for:</h4>
                <ul className="space-y-1.5 text-gray-600 text-sm">
            ...
            {/* Role 2 */}
            <div className="p-8 bg-white border border-gray-200 rounded-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Data Engineer — Fabric &amp; Power BI</h3>
              <p className="text-gray-600 mb-4">Build data foundations on Microsoft Fabric and Power BI for organizations getting AI-ready.</p>
              <div className="mb-4">
                <h4 className="font-semibold text-gray-900 mb-2">You will:</h4>
                <ul className="space-y-1.5 text-gray-600 text-sm">
            ...
            {/* Role 3 */}
            <div className="p-8 bg-white border border-gray-200 rounded-lg">
              <h3 className="text-2xl font-bold text-gray-900 mb-2">Platform Engineer — Azure / .NET</h3>
              <p className="text-gray-600 mb-4">Modernize .NET platforms and Azure infrastructure for mid-market clients.</p>
              <div className="mb-4">
                <h4 className="font-semibold text-gray-900 mb-2">You will:</h4>
                <ul className="space-y-1.5 text-gray-600 text-sm">
